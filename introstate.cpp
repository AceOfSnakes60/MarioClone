...
*/
    sf::Texture texture;
    if (!texture.loadFromFile("intro.bmp"))
    {
...
// while there are pending events...
    if (MarioClone.pollEvent(event)) //while (suggested) or if???
    {
...
void CIntroState::Update(CGameEngine* game)
{
    ...
    MarioClone.clear(sf::Color::Black);
    MarioClone.draw(sprite);
